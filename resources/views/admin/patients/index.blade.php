...
@section('content')
    ...
    <p>
        <ul class="list-inline">
            ...
            <li><a href="{{ route('admin.patients.index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">Inactive</a></li>
        </ul>
    </p>
    @endcan
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            window.dtDefaultOptions.columns = [
                ...
                @endif
                @endcan
                {data: 'assigned_therapist.name', name: 'assigned_therapist.name'},
