        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('assigned_therapist[]', $assigned_therapists, old('assigned_therapist') ? old('assigned_therapist') : $patient->assigned_therapist->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($patient->image)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$patient->image) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$patient->image) }}"></a>
                    @endif
            ...
            <div class="row">
                <div class="col-sm-4 form-group">
                    ...
                    {!! Form::date('birthday', old('birthday'), ['class' => 'form-control', 'placeholder' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('file', 'Other Files (pdf only)', ['class' => 'control-label']) !!}
                    @if ($patient->file)
                        <a href="{{ asset(env('UPLOAD_PATH').'/' . $patient->file) }}" target="_blank">Download file</a>
                    @endif
